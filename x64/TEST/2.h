...
public:
	virtual ~IAction() {}
	virtual void doAction(ITokCollection*& pTc, AST<element>& abstractSyntaxtTree) = 0;
};
...
public:
	...
	void doActions(ITokCollection*& pTc, AST<element>& abstractSyntaxtTree);
	virtual bool doTest(ITokCollection*& pTc, AST<element>& abstractSyntaxtTree) = 0;
